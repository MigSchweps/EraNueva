            ...
            while ($portfolio->have_posts()) : $portfolio->the_post();
                ...
                <li class="<?php nimble_portfolio_get_item_classes($post_id); ?>">
                    ...
                    <div class="nimble-portfolio-item" style="background: url('<?php echo $src[0]; ?>') center center no-repeat !important;">
                        <a href="<?php echo nimble_portfolio_get_meta('nimble-portfolio'); ?>" rel="lightbox[nimble_portfolio_gal_rect_1]">
                    ...
                    <div class="nimble-portfolio-links">
                        <a href="<?php the_permalink(); ?>" class="button-fixed">
                            <?php _e('Read More →', 'nimble_portfolio_context') ?>
                        </a> 
                        <a href="<?php echo nimble_portfolio_get_meta('nimble-portfolio-url'); ?>" class="button-fixed">
                            <?php _e('View Project →', 'nimble_portfolio_context') ?>
                        </a>
                    </div>
                </li>
                <?php
